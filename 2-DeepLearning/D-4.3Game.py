...
if 1==1:
    ...
    for episode in range(1, n_of_episodes + 1):
        ...
        for steps in range(n_of_steps):
            steps_executed += 1
            exploration_prob = ending_epsilon + (starting_epsilon - ending_epsilon) * np.exp(
                -decay_rate * steps_executed)
        ...
        print("Episode {}/{} completed, episode score {}, exploration_prob {:2f}".format(episode, n_of_episodes,
                                                                                         episode_score,
                                                                                         exploration_prob))
